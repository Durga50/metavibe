            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    ...
                    <div class="col-lg-5 col-md-12">
                        <div class="img-hero wow zoomIn" data-wow-delay="0.1s">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="0.7s">
                        <div class="service-card">
                            ...
                            <p>Regular content updates, bug fixes, and backups</p>
                            <ul class="service-features">
                                <li>Performance optimization and uptime monitoring</li>
                                <li>SSL renewal, plugin updates, and security checks</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="0.9s">
                        <div class="service-card">
                            <div class="service-icon">
                ...
                <div class="row g-4 justify-content-center">
                    <div class="col-lg-4 col-md-6 wow bounceInUp">
                        <div class="team-item rounded">
                            <img class="img-fluid rounded-circle mb-3" src="img/karthi1.jpeg" alt="">
                            <div class="team-content text-center py-3 bg-dark rounded-bottom">
                                <h4 class="text-primary">Karthikeyan B</h4>
                                <p class="text-white mb-4">Co-Founder & Chief Executive Officer</p>
                                <p class="mb-4">Visionary leader managing business strategy, operations, and client relations at KD MetaVibe.</p>
                                
                                <div class="team-social-links mt-3 mb-3">
                    ...
                    <div class="col-lg-4 col-md-6 wow bounceInUp" data-wow-delay="0.2s">
                        <div class="team-item rounded">
                            <img class="img-fluid rounded-circle mb-3" src="img/durga.jpeg" alt="">
                            <div class="team-content text-center py-3 bg-dark rounded-bottom">
                                <h4 class="text-primary">Durga E</h4>
                                <p class="text-white mb-4">Co-Founder & Chief Technology Officer</p>
                                <p class="mb-4">Technical lead responsible for web development, innovation, and project delivery.</p>
